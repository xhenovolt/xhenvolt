...
/**
 * Fallback used only when the CMS returns no published FAQs (e.g. DB offline
 * or not yet seeded). The server page (page.tsx) prefers CMS data.
 */
export const FALLBACK_FAQS: FaqGroup[] = [
  {
    category: "Services",
    questions: [
      {
...
export default function FaqClient({ groups }: { groups: FaqGroup[] }) {
  const faqs = groups.length > 0 ? groups : FALLBACK_FAQS;
